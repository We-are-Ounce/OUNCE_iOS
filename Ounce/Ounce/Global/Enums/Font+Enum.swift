...
enum Font {
    ...
    static let dateLabel = UIFont(name: "NotoSansKR-Regular", size: 16)
    
    // 회원가입
    static let signUpBigGuideLabel = UIFont(name: "NotoSansKR-Medium", size: 24)
    static let signUpSmallGuideLabel = UIFont(name: "NotoSansKR-Light", size: 24)
    static let errorLabel = UIFont(name: "NotoSansKR-Regular", size: 12)
    static let buttonLabel = UIFont(name: "NotoSansKR-Medium", size: 14)
